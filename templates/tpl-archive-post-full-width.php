<?php
/**
 * Full width content layout for posts. Content will expand to fill the viewport.
 *
 * @package Hermi
 * @since Hermi 0.1.0
 */
...
<div id="content-inner" class="site-content-inner">
	...
	<div class="layout-full-width">
		...
		<div class="layout-primary">
			<?php get_template_part( 'templates/parts/post-type/post/archive-loop', 'full-width' ); ?>
		</div><!-- .layout-primary -->
