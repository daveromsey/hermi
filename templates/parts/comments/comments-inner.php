...
if ( have_comments() ) { ?>
	...
	<?php // Are there comments to navigate through?
		if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) { ?>
			<nav class="pagination-comments pagination-comments-top pagination-container">
...
<?php
	...
	if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) { ?>
		<nav class="pagination-comments pagination-comments-bottom pagination-container">
			<?php get_template_part( 'templates/parts/comments/pagination-comments' ); ?>
		</nav>
<?php } ?>			
