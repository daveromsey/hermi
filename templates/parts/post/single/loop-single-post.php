	...
	<?php
		...
		if ( have_posts() ) {
			...
			while ( have_posts() ) {
				 ...
				 * called entry-content-post-___.php (where ___ is the Post Format name) and that will be used instead.
				 */
				get_template_part( 'templates/parts/post/entry-content-post', get_post_format() );
