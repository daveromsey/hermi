...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		<?php get_template_part( 'template-parts/post/common/entry-header-container-narrow' ); ?>
	</header><!-- .entry-header -->
	...
	<footer class="entry-footer">
		<?php get_template_part( 'template-parts/post/common/entry-footer-container-narrow' ); ?>
	</footer><!-- .entry-footer -->
