	...
	<?php
		...
		if ( have_posts() ) {
			...
			while ( have_posts() ) {
				 ...
				 */
				get_template_part( 'template-parts/post/content-post-container-wide', get_post_format() );

				if ( 'post' === get_post_type() ) {
					get_template_part( 'template-parts/pagination/pagination-single-container' );
				}
