			...
			<div class="small-12 columns">
				...
				<div class="attachment-image-wrap">
					<a href="<?php echo ( esc_url( $attachment_src_full[0] ) ); ?>">
						<img src="<?php echo ( esc_url( $attachment_src_thumb[0] ) ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>" width="<?php echo ( esc_attr( $attachment_src_thumb[1] ) ); ?>" height="<?php echo ( esc_attr( $attachment_src_thumb[2] ) ); ?>" />
					</a>
				</div>
