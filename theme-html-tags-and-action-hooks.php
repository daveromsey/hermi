...
<!-- Start <?php // get_template_part( 'templates/archive/layout', 'content-sidebar' ); ?> -------------------------------------- -->			
...
<!-- Start <?php // get_template_part( 'templates/archive/loop-archive' ); ?> -------------------------------------- -->			
							<?php do_action( 'hermi_content_before' ); ?>
							<main id="main-content" class="site-main">
								<?php
									do_action( 'hermi_content_top' );
								
									get_template_part( 'templates/archive/title-archive' );
...
<!-- Start <?php // get_template_part( 'templates/content/format', hermi_get_post_format_name() ); ?> -------------------------------------- -->			
										<?php do_action( 'hermi_entry_before' ); ?>
										<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
											<?php do_action( 'hermi_entry_top' ); ?>

											<?php
												get_template_part( 'templates/entry-sticky' );
												...
												get_template_part( 'templates/entry-meta-primary' );
											?>
											...
											<?php
												get_template_part( 'templates/entry-meta-secondary' );
											?>
							...
							<?php get_template_part( 'templates/navigation/pagination-archive' ); ?>
...
<!-- Start <?php // get_template_part( 'templates/sidebar/sidebar', 'main' ); ?> -------------------------------------- -->			
